/* Generated by Cython 0.14.1 on Wed Sep 14 20:09:37 2011 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API___classipy_kernels
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from _classipy_kernels */

static PyObject *__pyx_f_17_classipy_kernels_histogram_intersection(PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t = { "float64_t", NULL, sizeof(__pyx_t_5numpy_float64_t), 'R' };
#define __Pyx_MODULE_NAME "_classipy_kernels"
static int __pyx_module_is_main__classipy_kernels = 0;

/* Implementation of _classipy_kernels */
...
/* "classipy/classifiers/kernels/kernels.pyx":8
...
static PyObject *__pyx_pf_17_classipy_kernels_histogram_intersection(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static  PyObject *__pyx_f_17_classipy_kernels_histogram_intersection(PyArrayObject *__pyx_v_x, PyArrayObject *__pyx_v_y, int __pyx_skip_dispatch) {
  ...
  __Pyx_RefNannySetupContext("histogram_intersection");
  __pyx_bstruct_x.buf = NULL;
  __pyx_bstruct_y.buf = NULL;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_x, (PyObject*)__pyx_v_x, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_y, (PyObject*)__pyx_v_y, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "classipy/classifiers/kernels/kernels.pyx":9
 * 
 * cpdef histogram_intersection(np.ndarray[np.float64_t, ndim=2, mode='c'] x, np.ndarray[np.float64_t, ndim=2, mode='c'] y):
 *     cdef np.ndarray out = np.zeros((x.shape[0], y.shape[0]))             # <<<<<<<<<<<<<<
 *     histogram_intersection_fast(<double *>x.data, <double *>y.data, x.shape[0], y.shape[0], x.shape[1], <double *>out.data)
 ...
 */
  ...
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__zeros); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_to_py_Py_intptr_t((__pyx_v_x->dimensions[0])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_to_py_Py_intptr_t((__pyx_v_y->dimensions[0])); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_4 = 0;
  __pyx_t_4 = PyObject_Call(__pyx_t_2, ((PyObject *)__pyx_t_3), NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_3)); __pyx_t_3 = 0;
  if (!(likely(((__pyx_t_4) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_4, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_out = ((PyArrayObject *)__pyx_t_4);
  __pyx_t_4 = 0;

  /* "classipy/classifiers/kernels/kernels.pyx":10
 * cpdef histogram_intersection(np.ndarray[np.float64_t, ndim=2, mode='c'] x, np.ndarray[np.float64_t, ndim=2, mode='c'] y):
 *     cdef np.ndarray out = np.zeros((x.shape[0], y.shape[0]))
 *     histogram_intersection_fast(<double *>x.data, <double *>y.data, x.shape[0], y.shape[0], x.shape[1], <double *>out.data)             # <<<<<<<<<<<<<<
 *     return out
 ...
 */
  histogram_intersection_fast(((double *)__pyx_v_x->data), ((double *)__pyx_v_y->data), (__pyx_v_x->dimensions[0]), (__pyx_v_y->dimensions[0]), (__pyx_v_x->dimensions[1]), ((double *)__pyx_v_out->data));

  /* "classipy/classifiers/kernels/kernels.pyx":11
 *     cdef np.ndarray out = np.zeros((x.shape[0], y.shape[0]))
 *     histogram_intersection_fast(<double *>x.data, <double *>y.data, x.shape[0], y.shape[0], x.shape[1], <double *>out.data)
 *     return out             # <<<<<<<<<<<<<<
 *     #return np.array([[np.sum(np.min([x0, y0], 0)) for x0 in x] for y0 in y])
 */
  ...
  __Pyx_AddTraceback("_classipy_kernels.histogram_intersection");
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_y);
...
static PyObject *__pyx_pf_17_classipy_kernels_histogram_intersection(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_17_classipy_kernels_histogram_intersection(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("histogram_intersection", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "histogram_intersection") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
  ...
  __Pyx_RaiseArgtupleInvalid("histogram_intersection", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("_classipy_kernels.histogram_intersection");
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  __pyx_t_2 = ((PyObject *)__pyx_v_y);
  __Pyx_INCREF(__pyx_t_2);
  __pyx_t_3 = __pyx_f_17_classipy_kernels_histogram_intersection(((PyArrayObject *)__pyx_t_1), ((PyArrayObject *)__pyx_t_2), 0); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_r = __pyx_t_3;
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("histogram_intersection"), (PyCFunction)__pyx_pf_17_classipy_kernels_histogram_intersection, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    __Pyx_NAMESTR("_classipy_kernels"),
    0, /* m_doc */
    -1, /* m_size */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_classipy_kernels(void); /*proto*/
PyMODINIT_FUNC init_classipy_kernels(void)
#else
PyMODINIT_FUNC PyInit__classipy_kernels(void); /*proto*/
PyMODINIT_FUNC PyInit__classipy_kernels(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  #if CYTHON_REFNANNY
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit__classipy_kernels(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_classipy_kernels"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main__classipy_kernels) {
  ...
  /* "classipy/classifiers/kernels/kernels.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * 
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init _classipy_kernels");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init _classipy_kernels");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
